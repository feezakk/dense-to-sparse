...
from . import behaviors_teacher, jaxagent_teacher, jaxutils_teacher, nets_teacher
...
class WorldModel(nj.Module):
    def __init__(self, obs_space, act_space, config):
        ...
        self.encoder = nets_teacher.MultiEncoder(shapes, **config.encoder, name="enc")
        self.rssm = nets_teacher.RSSM(**config.rssm, name="rssm")
        self.heads = {
            "decoder": nets_teacher.MultiDecoder(shapes, **config.decoder, name="dec"),
            "reward": nets_teacher.MLP((), **config.reward_head, name="rew"),
            "cont": nets_teacher.MLP((), **config.cont_head, name="cont"),
        }
...
class VFunction(nj.Module):
    def __init__(self, rewfn, config):
        self.rewfn = rewfn
        self.config = config
        self.net = nets_teacher.MLP((), name="net", dims="deter", **self.config.critic)
        self.slow = nets_teacher.MLP((), name="slow", dims="deter", **self.config.critic)
